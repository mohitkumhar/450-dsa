...
def test_base_topbar_uses_button_utilities():
    ...
    assert 'class="pill-btn ui-btn ui-btn-secondary ui-btn-pill"' in base
    assert 'class="pill-btn accent ui-btn ui-btn-primary ui-btn-pill"' in base
    assert 'class="icon-btn ui-btn ui-btn-secondary ui-btn-icon"' in base
...
def test_topic_and_bookmarks_reuse_secondary_icon_and_pill_button_utilities():
    ...
    assert "filter-btn ui-btn ui-btn-secondary ui-btn-pill" in topic
    assert 'class="action-icon ui-btn ui-btn-secondary ui-btn-icon bookmark-btn' in topic
    assert 'class="notes-btn-sm ui-btn ui-btn-secondary' in topic
    assert 'class="back-btn ui-btn ui-btn-secondary"' in bookmarks
    assert 'class="action-icon ui-btn ui-btn-secondary ui-btn-icon bookmark-btn"' in bookmarks
...
def test_profile_reuses_primary_secondary_and_danger_button_utilities():
    ...
    assert 'class="card-btn ui-btn ui-btn-primary ui-btn-block"' in profile
    assert 'class="card-btn ui-btn ui-btn-secondary ui-btn-block"' in profile
    assert 'class="ui-btn ui-btn-danger ui-btn-block"' in profile
    assert 'class="add-btn ui-btn ui-btn-secondary ui-btn-block"' in profile
